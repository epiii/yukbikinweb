(function ($) {$(document).ready(function() {
 ...
 /* $(".featured.blog-box").hover(
    function () {
      $('.space').addClass('animated flipInY');
    },
    function () {      
      $('.space').removeClass('animated flipInY');
    }
  ); */
 /*
  $(".view-blog li article > a ").hover(
    function () {
      $(this).parent().children('.user-picture').addClass('animated lightSpeedIn');;
    },
    function () {      
      //$(this).delay(2000).removeClass('animated tada');
    }
  );
  */
 /*
  $('.blog-page .article .post-body p').bind('inview', function (event, visible) {
    if (visible) {
  ...
  $('.metro-panel .use-ajax').on( 'click', function() {
    //$('.portfolio-page').mCustomScrollbar("scrollTo","top");
  ...
  window.onhashchange = locationHashChanged;
    ...
    $('.goto').on( 'click', function() {
      ...
      /*
      $('.page-section').mCustomScrollbar("destroy");
      $('.page-section').mCustomScrollbar({
